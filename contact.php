        ...
        <div class="relative group">
          ...
          <div class="relative bg-gradient-to-br from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a] backdrop-blur-xl border-2 border-gold/30 rounded-3xl p-8 shadow-[0_20px_60px_-15px_rgba(255,215,0,0.2)]">
            ...
            <div class="flex gap-5">
              <a href="https://www.instagram.com/ettaajrentcars/" target="_blank" class="group/social relative w-16 h-16 bg-gradient-to-br from-purple-600 via-pink-600 to-red-500 rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-2xl overflow-hidden">
              ...
              <a href="https://www.facebook.com/profile.php?id=61559816313152" target="_blank" class="group/social relative w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-2xl overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover/social:translate-x-full transition-transform duration-700"></div>
